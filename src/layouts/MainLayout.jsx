      ...
      >
        <div className="flex h-20 shrink-0 items-center justify-between px-8 border-b border-white/10 bg-deep-900/30">
          <div className="flex items-center gap-3">
             <div className="h-10 w-10 rounded-full border-2 border-white/20 overflow-hidden shadow-lg bg-white">
               <img src="/logo.png" className="h-full w-full object-cover" style={{ mixBlendMode: 'multiply' }} alt="Logo" />
             </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden w-full max-w-full relative z-0">
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white/80 backdrop-blur-xl px-5 dark:border-white/5 dark:bg-deep-900/80 lg:hidden shadow-sm z-30">
          <div className="flex items-center gap-2.5">
             <div className="h-9 w-9 rounded-full border-2 border-mint-500 dark:border-mint-400 overflow-hidden shadow-md bg-white">
               <img src="/logo.png" className="h-full w-full object-cover" style={{ mixBlendMode: 'multiply' }} alt="Logo" />
             </div>
             <span className="text-xl font-extrabold text-deep-900 dark:text-white italic">
               Balanza
             </span>
          </div>
          <button
